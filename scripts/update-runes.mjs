...
const STAT_MAP = {
    ...
    '콤보 피해': 'comboHitDamage',
    '공격력': 'attackPower',
    '주는 피해': 'damageDealt',
    '적에게 주는 피해': 'damageDealt',
    '(적)받는 피해': 'damageReceived',
    '(적이)받는 피해': 'damageReceived',
    '(내가)받는 피해': 'damageReceived',
    '받는 피해': 'damageReceived',
    '멀티히트 피해': 'multiHitDamage',
    '스킬 피해': 'skillDamage',
    '차지 스킬 피해': 'skillDamage',
    '궁극기 피해': 'ultimateDamage',
    '쿨타임': 'cooldownReduction',
    '쿨타임 감소': 'cooldownReduction',
    '쿨타임 속도': 'cooldownRecovery',
    '쿨타임 회복 속도': 'cooldownRecovery',
    '캐스팅 속도': 'castingSpeed',
    '캐스팅/차지 속도': 'castingSpeed',
    '차지 속도': 'chargeSpeed',
    '스킬 사용 속도': 'skillSpeed',
    '치유량': 'healAmount',
    '회복력': 'healAmount',
    '무방비 피해': 'breakDamage',
    '브레이크 스킬 피해': 'breakDamage',
    '브레이크 피해': 'breakDamage',
    '지속 피해': 'dotDamage',
    '최종 피해': 'finalDamage',
    '방어력': 'defense',
